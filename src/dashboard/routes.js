    ...
    phases: [
      ...
      },
      {
        ...
        features: [
          ...
          { name: 'Premium Roofing CRM + Jarvis AI integration', status: 'done' },
          { name: 'ApexPrintLLC Etsy store + Printify pipeline', status: 'done' },
          { name: 'Etsy daily auto-listing pipeline (3/day at 10 AM ET)', status: 'done' },
          { name: 'Etsy SEO-optimized product generation', status: 'done' },
          { name: 'Etsy shop assets (icon/banner/story/bio via AI)', status: 'done' },
          { name: 'Autonomous ad spend optimization', status: 'planned' },
          { name: 'Cross-venture P&L dashboard', status: 'planned' },
        ],
      },
      {
        name: 'Phase 7 — Dashboard & UX',
        status: 'in-progress',
        features: [
          { name: 'Dungeon Mission Control (/mc) — gamified HUD', status: 'done' },
          { name: 'Canvas particle FX + data flow between rooms', status: 'done' },
          { name: 'XP bars + agent leveling system', status: 'done' },
          { name: 'Achievement popups', status: 'done' },
          { name: 'Holographic Command Center projection', status: 'done' },
          { name: 'CRT scanline overlay + parallax starfield', status: 'done' },
          { name: 'Room interior modals with live stats', status: 'done' },
          { name: 'Voice chat modal (Web Speech + ElevenLabs)', status: 'done' },
          { name: 'Build progression tab', status: 'done' },
          { name: 'Opus 4.6 brain upgrade (workers on Sonnet)', status: 'done' },
          { name: 'Memory context loaded into every chat', status: 'done' },
          { name: 'Self-work database lookup (no more web-search for own tasks)', status: 'done' },
          { name: 'Fulfillment engine (promises → real queued work)', status: 'done' },
        ],
      },
      {
